...
ECS_REGISTER_COMPONENT(ecs::AnimatorComponent);  // #4 Step B: animations/animationLayers inlined (StaticVector) -> no heap handles
ECS_REGISTER_COMPONENT(ecs::SkeletonComponent);   // #L1075: bones now BoneSoA (split arrays, self-owned) -> no DynamicPool handle
